...
import addInstallments from './functions-lib/add-installments.js';
import parseStatus from './functions-lib/parse-status-to-ecom.js';
  ...
  if (isCreditCard) {
    ...
    if (installmentsNumber && installmentsNumber > 1) {
      if (configApp.installments) {
        ...
        const { gateway } = addInstallments(amount.total, configApp.installments, {
          label,
...
// # sourceMappingURL=pagarme-create-transaction.js.map
